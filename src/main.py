...
BATTLE_HEROINE_LAST_WINDOW_WIDTH_M  = 80 / 27  # ズームアウト後
...
# 注視点：登場時、ヒロインの足元から何m上の位置を画面中央に合わせるか
BATTLE_HEROINE_FIRST_FOCUS_M = 0.2
...
def render_battle():
    ...
    if battle_back_img_raw and not dance_active:
        ...
        # bottom_y：注視点（FIRST_FOCUS_M）を画面中央に固定したままズームアウト後は
        # ANCHOR位置がバトルウィンドウ下端に来るよう補間
        bottom_y_start = SCREEN_H // 2 + int(BATTLE_HEROINE_FIRST_FOCUS_M * BATTLE_HEROINE_FIRST_METER_TO_PIXEL)
